/*I wanted to truncate the table sales_person since I only wanted to drop the values residing in side 
--the table and not the schema.
--Hence I used the truncate command.
--However, the sales_person tables uses a foreign key reference therefore; I had to drop other related 
-- tables as well. 

--GITHUB link --> https://github.com/derekbanas/postgresql-tutorial/blob/b383a9c263fcf79adb163e2701163569416eb559/PostgreSQL%20Tutorial.txt 
-- https://github.com/derekbanas/postgresql-tutorial/blob/main/PostgreSQL%20Tutorial.txt 
*/
TRUNCATE TABLE sales_item ,sales_order, sales_person, product, product_type, item;

--I can also delete all tables using the DROP clause
DROP TABLE sales_item ,sales_order, sales_person, product, product_type, item, customer;
