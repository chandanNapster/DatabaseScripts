  ...
  % \begin{align*}
    ...
    \begin{table}[h]
      ...
      \cline{1-3}
       ...
       \texttt{(a)-[FriendOf]->(b)-[FriendOf]->(c),} \\ \texttt{(c)-[FriendOf]->(d), (b)-[Knows]->(e)} \\ \texttt{(c)-[Knows]->(f)} & \texttt{Four Hops And Branches} & $ \drop{m,n}{\rename{f_{id}}{m}{F} \NJoin \rename{p_{id}}{m}{\rename{f_{id}}{n}{F}} \NJoin \rename{p_{id}}{m}{\rename{k_{id}}{k}{K}} \NJoin \rename{p_{id}}{n}{F} \NJoin \rename{p_{id}}{n}{K}} $ && \\ \cline{1-3}
